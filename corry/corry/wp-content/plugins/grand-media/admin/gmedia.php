					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							...
							<div class="input-group input-group-sm">
								<input name="meta[_gps]" type="text" readonly="readonly" class="form-control input-sm gps_map_coordinates" value="<?php echo $gps; ?>" placeholder="<?php _e('Latitude, Longtitude', 'grand-media'); ?>" autocomplete="off" />
